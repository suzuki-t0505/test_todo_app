defmodule TestTodoAppWeb.AccountAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_test_todo_app_web_account_remember_me"
  ...
  def log_out_account(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TestTodoAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_account:
      ...
      defmodule TestTodoAppWeb.PageLive do
        use TestTodoAppWeb, :live_view

        on_mount {TestTodoAppWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TestTodoAppWeb.AccountAuth, :ensure_authenticated}] do
